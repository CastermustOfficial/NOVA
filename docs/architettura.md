...
| D84 | All'avvio l'orb sta sul principale, anche se l'utente l'aveva lasciato altrove | all'accensione l'utente non ha chiesto niente: ha acceso il computer, e l'orb e' l'unica cosa che dice che NOVA c'e'. Se compare su uno schermo spento la conclusione non e' «sara' sull'altro monitor», e' «non e' partita» — misurato due volte, la seconda a x=-113 su un monitor che Windows elencava regolarmente. Ed e' il momento peggiore per fidarsi dell'elenco, perche' un secondo schermo puo' non essersi ancora svegliato. Sbagliare in un verso costa una trascinata, nell'altro costa la fiducia |
