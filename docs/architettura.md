...
| D41 | Senza scheda video leggibile l'installatore non offre il modello locale: salta il passo e suggerisce di riprovare piu' avanti con un modello a pochi parametri attivi | «servono N GB di VRAM: andra' piano» e' troppo gentile per un denso da 27B: non e' piu' piano, e' un programma che si installa dopo tredici gigabyte e non si apre piu'. Un avvertimento piu' grosso non basta - la scelta va tolta. E la soglia si scrive in parametri **attivi**, non in gigabyte: il MoE da 26B usabile ne pesa dodici, un denso da 7B ne pesa quattro e va piu' piano di lui |
