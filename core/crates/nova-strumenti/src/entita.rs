//! Le entita' HTML con un nome, tutte.
//!
//! **Estratte, non ricopiate.** Sono duemilacentoventicinque nomi: anche solo
...
//! **apposta** per vedere dove finiva — `&oelig;`, `&thorn;`, `&notin;` e
//! altre. Il Rust le lasciava scritte com'erano e il Python le scioglieva.
//! Vedere dove finisce una tabella e' meglio che scoprirlo.
//!
//! Il punto e virgola non c'e': lo gestisce chi legge, perche' sulle pagine
//! vere manca spesso. La prima estrazione teneva solo i nomi che nel
//! dizionario di Python stanno **senza** punto e virgola, ed erano centosei —
//! un numero abbastanza plausibile da non far sospettare niente.

/// Nome dell'entita' (senza `&` e senza `;`) e cosa vuol dire.
///
/// In ordine alfabetico, cosi' si puo' cercare per dimezzamenti; e il valore
/// e' una stringa e non un carattere perche' qualche entita' ne vale due
/// (`&NotEqualTilde;` e i suoi parenti).
pub const ENTITA: &[(&str, &str)] = &[
    ("AElig", "\u{c6}"),
    ("AMP", "&"),
    ("Aacute", "\u{c1}"),
    ("Abreve", "\u{102}"),
