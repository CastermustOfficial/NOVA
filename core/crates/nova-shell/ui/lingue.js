...
export const LINGUE = {
  en: {
    ...
    'Posso farlo?': 'May I do this?',
    'Posso farlo? È un’azione rischiosa.': 'May I do this? It is a risky action.',
    'Sì, fallo': 'Yes, do it',
    'No': 'No',
    'consentito': 'allowed',
    'negato': 'denied',
    'non più in attesa': 'no longer waiting',
    'nessuna risposta: l’ho considerato un no': 'no answer: I took it as a no',
    'non sono riuscita a mandare la risposta: ': 'I could not send the answer: ',
    ...
    /* --- harness --- */
    'NOVA — harness': 'NOVA — harness',
    'Cartella': 'Folder',
    'File': 'File',
    'Chat': 'Chat',
    'Esplora': 'Explorer',
    'Apri una cartella (Ctrl+Maiusc+O)': 'Open a folder (Ctrl+Shift+O)',
    'Apri un file (Ctrl+O)': 'Open a file (Ctrl+O)',
    'Mostra o nascondi la chat (Ctrl+J)': 'Show or hide the chat (Ctrl+J)',
    'Rileggi la cartella': 'Reload the folder',
    'Anteprima': 'Preview',
    'Anteprima accanto (Ctrl+Maiusc+V)': 'Preview alongside (Ctrl+Shift+V)',
    'Apri qualcosa su cui lavorare': 'Open something to work on',
    'Una cartella, e i suoi file compaiono a sinistra. Oppure chiedi a NOVA di aprirti un file.': 'A folder, and its files appear on the left. Or ask NOVA to open a file for you.',
    'Apri una cartella': 'Open a folder',
    'Apri un file': 'Open a file',
    'Aperte di recente': 'Recently opened',
    'Nessuna cartella aperta.': 'No folder open.',
    'La cartella è vuota.': 'The folder is empty.',
    'modifiche non salvate': 'unsaved changes',
    'L’editor completo non c’è: non è stato scaricato quando il guscio è stato compilato. Uso un foglio semplice, senza colori. Per averlo, ricompila il guscio con la rete.': 'The full editor is missing: it was not downloaded when the shell was built. Using a plain sheet, without colours. To get it, rebuild the shell with a network connection.',
    'Chiedi a NOVA su questo': 'Ask NOVA about this',
    'Chiudi (Ctrl+W)': 'Close (Ctrl+W)',
    'Testo': 'Text',
    'Questo file non si apre nell’editor.': 'This file does not open in the editor.',
    'Le immagini non si aprono ancora nell’harness.': 'Images do not open in the harness yet.',
    'I PDF e i documenti Word si vedranno qui con le pagine vere: arrivano con la quarta fase. Intanto chiedi a NOVA di aprirlo: te lo mostra nella finestra di prima, con le pagine, e puoi farle domande sopra.': 'PDFs and Word documents will show here with their real pages: they come with phase four. Meanwhile ask NOVA to open it: she shows it in the previous window, with its pages, and you can ask her about it.',
    'Il testo che NOVA legge in questo documento. Le pagine vere arrivano con la quarta fase.': 'The text NOVA reads in this document. The real pages come with phase four.',
    'PAGINA': 'PAGE',
    '«': '“',
    '» ha modifiche non salvate.': '” has unsaved changes.',
    '» è stato cambiato sul disco dopo che l’hai aperto.': '” was changed on disk after you opened it.',
    '» è cambiato sul disco, e qui hai modifiche non salvate.': '” changed on disk, and you have unsaved changes here.',
    'Salva': 'Save',
    'Non salvare': 'Don’t save',
    'Annulla': 'Cancel',
    'Sovrascrivi': 'Overwrite',
    'Ricarica dal disco': 'Reload from disk',
    'Tieni le mie': 'Keep mine',
    'Salvato: ': 'Saved: ',
    'Ricaricato, era cambiato sul disco: ': 'Reloaded, it changed on disk: ',
    '1 file non salvato': '1 unsaved file',
    'file non salvati': 'unsaved files',
    'Riga': 'Ln',
    'Col': 'Col',
    'Permessi:': 'Permissions:',
    'fa da sola': 'acts on her own',
    'chiede sempre': 'always asks',
    'chiede se rischioso': 'asks when risky',
    'Chiedimi dei file che hai aperto.': 'Ask me about the files you have open.',
    'So cosa hai davanti e cosa hai selezionato: «cosa fa questa funzione?», «c’è un errore qui?».': 'I know what is in front of you and what you selected: “what does this function do?”, “is there a bug here?”.',
    'Chiedi a NOVA…': 'Ask NOVA…',
    'Invio per mandare · Maiusc+Invio per andare a capo': 'Enter to send · Shift+Enter for a new line',
    'riga': 'line',
    'righe': 'lines',
    'del file che hai davanti': 'of the file in front of you',
    'Non so a quale file si riferisce: apri la cartella del progetto.': 'I do not know which file this refers to: open the project folder.',
    'Non mandarlo con la domanda': 'Do not send it with the question',
    'Mandalo con la domanda': 'Send it with the question',
    'La selezione va con la domanda': 'The selection goes with the question',
    'Apri l’harness: i file e la chat accanto': 'Open the harness: your files with the chat alongside',

    /* --- harness: le proposte e le prove --- */
    '1 proposta in attesa': '1 proposal waiting',
    'proposte in attesa': 'proposals waiting',
    'Proposta di NOVA su ': 'NOVA’s proposal on ',
    'Scegli un file': 'Pick a file',
    'Dall’albero a sinistra, oppure chiedi a NOVA di aprirtelo.': 'From the tree on the left, or ask NOVA to open it for you.',
    'PDF/Word': 'PDF/Word',
    'Nessuna modifica in attesa. Quando NOVA ne propone una, la trovi qui.': 'No changes waiting. When NOVA proposes one, you will find it here.',
    'in parte non si applica più: il file è cambiato': 'partly no longer applies: the file changed',
    'si guarda nella finestra di prima': 'shown in the previous window',
    'Questa proposta è su un PDF o un Word: si guarda nella finestra di prima.': 'This proposal is on a PDF or Word file: it is shown in the previous window.',
    'Senza l’editor completo il confronto non si vede: questo è il file come sarebbe, e lo puoi ritoccare.': 'Without the full editor the comparison is not shown: this is the file as it would be, and you can adjust it.',
    'Non tutto si applica più, perché il file è cambiato da quando NOVA ha proposto: ': 'Not everything applies any more, because the file changed since NOVA proposed: ',
    'Proposta di NOVA': 'NOVA’s proposal',
    'Pezzo prima': 'Previous change',
    'Pezzo dopo': 'Next change',
    'Rifiuta questo pezzo': 'Reject this change',
    'Rimette le righe di prima al posto di questo pezzo; il resto della proposta resta': 'Puts the previous lines back in place of this change; the rest of the proposal stays',
    'In linea': 'Inline',
    'Affiancato': 'Side by side',
    'Scarta': 'Discard',
    'Applica e prova': 'Apply and test',
    'Scrive, prova il progetto, e rimette tutto com’era se un test che passava cade': 'Writes, tests the project, and puts everything back if a test that passed now fails',
    'Accetta': 'Accept',
    'Scrive il file come lo vedi a destra (Ctrl+S)': 'Writes the file as you see it on the right (Ctrl+S)',
    'provo prima e dopo le modifiche…': 'testing before and after the changes…',
    'Il file è cambiato sul disco dopo che hai guardato la proposta: la ricarico, così vedi il confronto giusto.': 'The file changed on disk after you looked at the proposal: I reload it, so you see the right comparison.',
    'Va bene': 'OK',
    'Non l’ho applicata.': 'I did not apply it.',
    'Applicata': 'Applied',
    'Applicate': 'Applied',
    'la copia di prima sta accanto, «.prima»': 'the previous copy sits next to it, “.prima”',
    'Butto la proposta in attesa?': 'Discard the waiting proposal?',
    'Butto tutte le proposte in attesa?': 'Discard all waiting proposals?',
    'decise': 'decided',
    'Modifiche proposte': 'Proposed changes',
    '1 file': '1 file',
    'file': 'files',
    'Guarda': 'Look',
    ...
    'prima': 'before',
    'dopo': 'after',
    'Ultima prova: ': 'Last test run: ',
    'Apri prima la cartella del progetto.': 'Open the project folder first.',
    'provo il progetto…': 'testing the project…',
    'Esplora (Ctrl+Maiusc+E)': 'Explorer (Ctrl+Shift+E)',
    'Modifiche proposte da NOVA (Ctrl+Maiusc+M)': 'Changes proposed by NOVA (Ctrl+Shift+M)',
    'Test': 'Tests',
    'Modifiche': 'Changes',
    'Scarta tutto': 'Discard all',
    'Prova il progetto': 'Test the project',
    'Scrive tutte le proposte, come le vedi': 'Writes all proposals, as you see them',
