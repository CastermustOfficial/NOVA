...
$binari = @('novad.exe', 'nova-shell.exe', 'nova.exe', 'nova-catalogo.exe', 'nova-cartelle.exe', 'nova-schede.exe', 'nova-appunti.exe', 'nova-volume.exe', 'nova-notifica.exe', 'nova-sistema.exe', 'nova-app.exe', 'nova-finestre.exe')
